...
public class DBpediaQuery {
    ...
    public static ArrayList<String> getDBpediaConnections(String docTitle, int limit) throws IOException{
        ...
        String outgoing = execCmd("curl \"http://dbpedia.org/sparql?query=PREFIX%20%3A%20%3Chttp%3A%2F%2Fdbpedia.org%2Fresource%2F%3E%20"
        ...
        String incoming = execCmd("curl \"http://dbpedia.org/sparql?query=PREFIX%20%3A%20%3Chttp%3A%2F%2Fdbpedia.org%2Fresource%2F%3E%20"
                                       + "PREFIX%20rdfs%3A%20%3Chttp%3A%2F%2Fwww.w3.org%2F2000%2F01%2Frdf-schema%23%3E%20"
